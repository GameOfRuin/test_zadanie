...
module.exports = {
    up: (0, transaction_wrapper_1.wrapWithTransaction)(async (transaction, queryInterface, sequelize) => {
        return queryInterface.createTable(dictionary_1.Tables.transactions, {
            ...
            [dictionary_1.Columns.amount]: {
                type: sequelize_typescript_1.DataType.DECIMAL(15, 2),
                allowNull: true,
            },
            [dictionary_1.Columns.action]: {
            ...
            [dictionary_1.Columns.userId]: {
                type: sequelize_typescript_1.DataType.INTEGER,
                allowNull: false,
                references: {
                    model: dictionary_1.Tables.users,
                    key: dictionary_1.Columns.id,
                },
                onUpdate: 'CASCADE',
                onDelete: 'CASCADE',
            },
    ...
    down: (0, transaction_wrapper_1.wrapWithTransaction)(async (transaction, queryInterface, sequelize) => {
        return queryInterface.dropTable(dictionary_1.Tables.transactions, {
            transaction,
        });
    }),
};
//# sourceMappingURL=002-create-article-table.js.map